...
public class Stemmer_Indexer {
     ...
     * @throws IOException
     */
    public Stemmer_Indexer(String indexDirectoryPath) throws IOException { //we create the path of the index
     ...
     * @throws IOException
     */
    private Document getDocument(DocumentFields datadoc) throws IOException {
     ...
     * @throws IOException
     */
    private void indexFile(DocumentFields datadoc) throws IOException {
     ...
     * @throws IOException
     */
    public int createIndex(ArrayList<DocumentFields> docs) throws IOException {
        for (DocumentFields d : docs) {
            indexFile(d);
        }
